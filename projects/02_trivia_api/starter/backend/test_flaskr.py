...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_delete_question(self):
        res=self.client().post('/questions', json={'question':"Which city is capital of US",
    ...
    def test_404_if_category_not_valid_for_get_question_based_on_category(self):
    ...
    def test_404_if_search_is_absent_for_search_question_based_on_string(self):
        res=self.client().post('/questions/search', json={'searchTerm':"Ubiquitious"})
        data=json.loads(res.data)
    ...
    def test_404_if_category_is_invalid_for_quiz(self):
        res=self.client().post('/quizzes', json={'previous_questions':[14],
        'quiz_category':{'type':'Mathematics', 'id':'14'}})
        data=json.loads(res.data)
